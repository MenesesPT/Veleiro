...
class LoRa {
 ...
 public:
  enum freq_t { FREQ_433 = 433003300, FREQ_868 = 868100000, FREQ_915 = 915000000 };
  static const uint32_t bw[10];
  enum bw_t { BW_7k8, BW_10k4, BW_15k6, BW_20k8, BW_31k25, BW_41k7, BW_62k5, BW_125k, BW_250k, BW_500k };
  enum sf_t { SF_6 = 6, SF_7, SF_8, SF_9, SF_10, SF_11, SF_12 };
  enum hm_t { HM_EXPLICIT, HM_IMPLICIT };
  enum cr_t { CR_45 = 1, CR_46, CR_47, CR_48 };
  enum lna_gain_t { LNA_G1 = 1, LNA_G2, LNA_G3, LNA_G4, LNA_G5, LNA_G6, LNA_AGC };
